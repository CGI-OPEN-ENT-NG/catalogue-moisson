package fr.openent.moisson.config.timezone;

import fr.openent.moisson.MoissoncatalogueApp;
import fr.openent.moisson.repository.timezone.DateTimeWrapper;
import fr.openent.moisson.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM moisson_date_time_wrapper where id=%d", fieldName, id);
    }
