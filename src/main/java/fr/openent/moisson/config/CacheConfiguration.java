...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.openent.moisson.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.openent.moisson.repository.UserRepository.USERS_BY_EMAIL_CACHE);
