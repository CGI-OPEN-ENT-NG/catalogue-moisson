...
/**
 * REST controller for managing {@link fr.openent.moisson.domain.Niveau}.
 */
@RestController
@RequestMapping("/api")
public class NiveauResource {
    ...
    public ResponseEntity<List<NiveauDTO>> searchNiveaus(@RequestParam String query, Pageable pageable) {
