 ...
 * in {@link fr.openent.moisson.web.rest.DisciplineResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /disciplines?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DisciplineCriteria implements Serializable, Criteria {
    ...
    public DisciplineCriteria(DisciplineCriteria other) {
    ...
    @Override
    public DisciplineCriteria copy() {
        return new DisciplineCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DisciplineCriteria that = (DisciplineCriteria) o;
        return
